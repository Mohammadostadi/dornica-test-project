...
<div class="wrapper">
    ...
    ?>
        ...
        <div class="page-breadcrumb   d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a class="btn btn-outline-secondary" href="page_add.php"> اضافه کردن داده جدید</a>
                        ...
                        <div class="card border shadow-none w-100">
                            ...
                            <div class="card-header">
                                <div id="<?= (isset($_SESSION['page_filter']['page']) and !empty($_SESSION['page_filter']['page']))?"":"filter-row"?>" >
                                    ...
                                    <div class="col-lg-2 col-md-4" > <input class="col form-control" type="text" value="<?= isset($_SESSION['page_filter']['code'])?$_SESSION['page_filter']['code']:"" ?>" name="code" placeholder="کد" > </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <a href="<?= sort_link('setdate') ?>" class="sort-table <?= sortActive('setdate') ?>"></a>
                                                زمان</th>
                                            <th>
                                            <a href="<?= sort_link('code') ?>" class="sort-table <?= sortActive('code') ?>"></a>
                                                کد</th>
                                            <th>
