...
$res = $filter->filterCheck($db, $data, 'comment', 'comments_list.php', $query, 1, $sortField, $sortOrder, isset($member_comment) ? $member_comment : '');
?>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                <?php foreach ($res as $key => $comment) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <a id="edit"
                                                                    class=" btn border-0 bx p-0 bx-edit" data-toggle="modal"
                                                ...
                                                <i class="lni lni-comments"></i>
                                                    ...
                                                    <div class="hide modal fade" id="exampleModal" tabindex="-1"
