<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if($validator->count_error() == 0){
            ...
            redirect('shippingtypes_list.php', 2);
        }
    }
                                ...
                                <form class="row g-3 needs-validation" novalidate action="" method="post">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch" name="check" id="flexSwitchCheckChecked" <?= $shipping['status']==1? 'checked':  '' ; ?> >
                                            </div>                                    
                                    ...
                                    <div class="col-lg-4">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="d-grid">
                                                        <a href="shippingtypes_list.php" class="btn btn-danger">برگشت</a>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="d-grid">
