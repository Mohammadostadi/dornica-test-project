...
<div class="wrapper">
    ...
    <?php
        ...
        <div class="page-breadcrumb   d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a class="btn btn-outline-secondary" href="shippingtype_add.php"> اضافه کردن داده جدید</a>
                            ...
                            <div class="card-header">
                                <div id="<?= (isset($_SESSION['shipping_type_filter']['shipping_type']) and !empty($_SESSION['shipping_type_filter']['shipping_type']))?"":"filter-row"?>" class="<?= (isset($_SESSION['shipping_type_filter']['shipping_type']) and !empty($_SESSION['shipping_type_filter']['shipping_type']))?"":"d-none"?>">
                                    ...
                                    <div class="col-lg-2 col-md-4" > <select class="form-select text-secondary" name="status" id="status">
                                        ...
                                        <option <?= (isset($_SESSION['shipping_type_filter']['status']) and $_SESSION['shipping_type_filter']['status']== 1) ? 'selected' : '' ?> value="1">فعال</option>
                                        <option <?= (isset($_SESSION['shipping_type_filter']['status']) and $_SESSION['shipping_type_filter']['status'] == 0) ? 'selected' : '' ?> value="0">غیر فعال</option>
                                    </select> </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3 fs-6">
                                                        ...
                                                        ?>
                                                        <button class="<?= !empty($res)?"disabled text-secondary":"open-confirm text-danger" ?> btn border-0" value="<?= $ship['id'] ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?= !empty($res)?"قابل حذف نیست":"حذف" ?>" data-bs-original-title="حذف" aria-label="Delete"><i class="bi bi-trash-fill"></i></button>
                                                    </div>
                                                </td>
                                            </tr>
