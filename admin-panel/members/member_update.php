                        ...
                        <form class="row g-3 needs-validation" novalidate action="" method="post"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="fname"
                                    value="<?= checkUpdate('fname', $member['fname']) ?>" required>
                                <span
                                    class="text-danger"><?= $validator->is_exist('fname') ? $validator->show('fname') : '' ?></span>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="lname"
                                    value="<?= checkUpdate('lname', $member['lname']) ?>" required>
                                <span
                                    class="text-danger"><?= $validator->is_exist('lname') ? $validator->show('lname') : '' ?></span>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-select" name="gender" id="gender" required>
                                    ...
                                    <option <?= ((isset($_POST['gender']) and $_POST['gender'] == 0) or ($member['gender'] == 0)) ? "SELECTED" : "" ?> value="0">مرد</option>
                                    <option <?= ((isset($_POST['gender']) and $_POST['gender'] == 1) or ($member['gender'] == 1)) ? "SELECTED" : "" ?> value="1">زن</option>
                                </select>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select id="state" name="state" class="form-control">
                                    ...
                                    foreach ($provinceList as $province) { ?>
                                        <option <?= $member['province_id'] == $province['id'] ? "SELECTED" : "" ?>
                                            value="<?= $province['id'] ?>"><?= $province['name'] ?></option>
                                    <?php } ?>
                                </select>
                                <span
                                    class="text-danger"><?= $validator->is_exist('state') ? $validator->show('state') : '' ?></span>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <span
                                    class="text-danger"><?= $validator->is_exist('city') ? $validator->show('city') : '' ?></span>
                            </div>
                            <div class="col-lg-6">
                                <label class="form-label">کدملی</label>
                                <input type="text" class="form-control" name="ncode"
                                    value="<?= checkUpdate('ncode', $member['national_code']) ?>" required>
                                <span
                                    class="text-danger"><?= $validator->is_exist('ncode') ? $validator->show('ncode') : '' ?></span>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="email"
                                    value="<?= checkUpdate('email', $member['email']) ?>" required>
                                <span
                                    class="text-danger"><?= $validator->is_exist('email') ? $validator->show('email') : '' ?></span>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="phone"
                                    value="<?= checkUpdate('phone', $member['phone']) ?>" required>
                                <span
                                    class="text-danger"><?= $validator->is_exist('phone') ? $validator->show('phone') : '' ?></span>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="postalCode"
                                    value="<?= checkUpdate('postalCode', $member['postal_code']) ?>">
                                <span
                                    class="text-danger"><?= $validator->is_exist('postalCode') ? $validator->show('postalCode') : '' ?></span>
                            </div>
                            <div class="col-12">
                                <label class="form-label">آدرس</label>
                                <textarea class="form-control" rows="3"
                                    name="address"><?= checkUpdate('address', $member['address']) ?></textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label">تصویر</label>
                                <div class="row">
                                    <div class="col-12 text-center bg-light my-3 rounded preview">
                                        <img src="../../<?= $member['image'] ?>" class="rounded-circle shadow m-3"
                                            id="img" width="100" height="100" alt="">
                                    </div>
                                    <div class="col-12">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="check"
                                            id="flexSwitchCheckChecked" <?= $member['status'] == 1 ? 'checked' : ''; ?>>
                                    </div>
