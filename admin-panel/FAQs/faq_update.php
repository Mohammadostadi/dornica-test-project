...
<body>
                        ...
                        <form class="row g-3 needs-validation" novalidate action="" method="post">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="title"
                                    value="<?= checkUpdate('title', $faq['title']) ?>" required>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="number" class="form-control" name="sort"
                                    value="<?= checkUpdate('sort', $faq['sort']) ?>" oninput="number(this)" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="editor1" rows="3" placeholder="توضیحات"
                                    name="description"><?= checkUpdate('description', $faq['description']) ?></textarea>
                            </div>
                            <div class="col-lg-8">
                                <div class="d-flex">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="check"
                                            id="flexSwitchCheckChecked" <?= $faq['status'] == 1 ? 'checked' : ''; ?>>
                                    </div>
    ...
    <script src="assets/js/faq_edit.js"></script>
</body>
