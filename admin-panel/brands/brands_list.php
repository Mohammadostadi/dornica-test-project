<?php $prefix='brand' ; require_once('../../app/loader.php'); if(isset($_GET['back'])){ unset($_SESSION['brand']);
    } sortInTable($prefix, 'brands_list' , 'page' ); $filter=new Filter('brand', 'brand_filter' ); $data=[ 'name'=>
    'like',
    'status'=>'=',
    ];
                                ...
                                <div class="card border shadow-none w-100">
                                    <div class="card-body">
                                        <div class="card-header">
                                            <div id="<?= (isset($_SESSION['brand_filter']['brand']) and !empty($_SESSION['brand_filter']['brand'])) ? "" : "filter-row" ?>"
                                                ...
                                                <form class="" id="form" action="brands_list.php?page=1" method="post">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-lg-2 col-md-4 text-center button-filter">
                                                        ...
                                                        <?php if (isset($_SESSION['brand_filter']['brand']) and !empty($_SESSION['brand_filter']['brand'])) { ?>
                                                            <div class="col-lg-2 col-md-4 button-filter"> <button
