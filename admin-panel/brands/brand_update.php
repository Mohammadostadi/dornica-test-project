                        ...
                        <form class="row g-3 needs-validation" novalidate action="" method="post"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="name"
                                    value="<?= checkUpdate('name', $brand['name']) ?>" required>
                                <span
                                    class="text-danger"><?= $validator->is_exist('name') ? $validator->show('name') : '' ?></span>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-12 text-center bg-light my-3 rounded preview">
                                        <img src="../../<?= $brand['logo'] ?>" class="rounded-circle shadow m-3" id="img"
                                ...
                                <span
                                    class="text-danger"><?= $validator->is_exist('fileToUpload') ? $validator->show('fileToUpload') : '' ?></span>
                            </div>
                            <div class="col-lg-8">
                                <div class="d-flex">
