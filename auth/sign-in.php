                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-4 p-sm-5">
                                ...
                                <form class="form-body needs-validation" novalidate action="" method="post">
                                    ...
                                    <div class="login-separater text-center mb-4"> <span>یا با ایمیل وارد شوید</span>
                                        <hr>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input type="password" name="password" class="form-control radius-30 ps-5" id="inputChoosePassword" placeholder="رمز عبور را وارد کنید" required>
                                        ...
                                        <div class="col-6 text-end">	<a href="forgot_password.php">رمز عبور را فراموش کرده اید؟</a>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" name="sign_in" class="btn btn-primary radius-30">ورود</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
